...
git clone git@github.com:pip-services-users2/facade-users-node.git
...
git clone git@github.com:pip-services-users2/service-orgroles-node.git
git clone git@github.com:pip-services-users2/service-organizations-node.git
...
git clone git@github.com:pip-services-users2/client-organizations-node.git
git clone git@github.com:pip-services-users2/client-msgdistribution-node.git
git clone git@github.com:pip-services-users2/client-invitations-node.git
git clone git@github.com:pip-services-users2/client-emailsettings-node.git
